          ...
          <div class="card-body">
            <div class="row justify-content-between mb-2">
              ...
              <div class="col-auto m-3">
                <button type="button" data-toggle="modal" data-target="#addServiceModal" class="btn btn-primary btn-modaladdservice">Tambah Service</button>
              </div>
            </div>
            <table width="100%" id="service_table" class="table">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Judul</th>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('click', '.btn-modaladdservice', function(e) {
      e.preventDefault();
      var id = $(this).data('id');

      if (id == '') {
        var url = 'serviceadmin/form_add';
      }
      $.ajax({
        url: '<?= base_url('serviceadmin/form_add'); ?>',
        method: "POST",
        data: {
          id: id
        },
        success: function(response) {
          ...
          var modal = new bootstrap.Modal($('#serviceModal'));
          modal.show();
        },
    ...
    var table = $('#service_table').DataTable({
      ...
      responsive: true,
      searching: true,
      ajax: "<?php echo base_url('serviceadmin/datatables'); ?>",
      order: [],
      "columns": [{
          "data": "id",
          orderable: false,
        ...
        },
        {
          ...
          "render": function(data, type, row) {
            if (data) {
              return '<img src="assets/uploads/cms/image/service/' + data + '" width="100">';
            } else {
              return '';
            }
          }
    ...
    $('#add_service_form').submit(function(e) {
      e.preventDefault();
      $.ajax({
        url: "<?php echo base_url('service/form_add'); ?>",
        method: "POST",
